...
## Corpus Check
- 120 files · ~165,501 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1756 nodes · 3683 edges · 96 communities (90 shown, 6 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 37 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `787f444a`
...
Cohesion: 0.17
Nodes (6): Claude Code instructions, Branch protection contract, Contributing to Keeplin, Contribution flow, Cross-repository changes, Prompt roles
...
### Community 93 - "0.B — Implementación de un issue"
Cohesion: 0.50
...
## Knowledge Gaps
- **823 isolated node(s):** `check-graph.sh script`, `dr-drill.sh script`, `Purpose`, `Enabling`, `Behaviour` (+818 more)
