...
| [0009 — Review governance is evaluated from the default branch](https://github.com/jsunyermias/keeplin/blob/main/docs/adr/0009-governance-evaluated-from-the-default-branch.md) | proposed | extends 0008. Would move the independent-review gate into the trusted default-branch evaluator here too, so a pull-request head cannot weaken it. Unimplemented while proposed |
