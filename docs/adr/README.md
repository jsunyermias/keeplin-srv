...
| [0009 — Review governance is evaluated from the default branch](https://github.com/jsunyermias/keeplin/blob/main/docs/adr/0009-governance-evaluated-from-the-default-branch.md) | accepted | extends 0008. Would move the independent-review gate into the trusted default-branch evaluator here too, so a pull-request head cannot weaken it. Accepted and unimplemented; implementation belongs in its own dedicated pull request |
